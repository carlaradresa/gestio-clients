package com.serviemporda.gestioclients.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.serviemporda.gestioclients.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.serviemporda.gestioclients.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, com.serviemporda.gestioclients.domain.PlantillaFeina.class.getName() + ".treballadors");
            createCache(cm, com.serviemporda.gestioclients.domain.Treballador.class.getName() + ".plantillafeinas");
